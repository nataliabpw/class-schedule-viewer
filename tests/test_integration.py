...
def test_full_flow_with_mock_df():
    ...
    schedule = format_schedule_with_time(classes, df, start_row=3, time_column_id=0)

    assert schedule == [
        {"name": "Biochemia zajęcia praktyczne - grupa 1b", "start": "08.00", "end": "09.00"},
        {"name": "Anatomia ćwiczenia - grupa 1a", "start": "09.00", "end": "11.00"},
    ]